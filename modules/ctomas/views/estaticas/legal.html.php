    ...
    <div class="wrapper">
        ...
        <main>
			<section class="module content">
                <div class="container">
					<h2 class="title"> Política de Privacidad (Protección de Datos)</h2>

					<p>Por medio de este sitio web se recogen datos de carácter personal
					necesarios para la gestión y mantenimiento de algunos de nuestros
					servicios. Dichos datos son incluidos en nuestros ficheros, que se 
					encuentran convenientemente inscritos en el Registro de la Agencia de
					Protección de Datos.</p>

					<p>Sin perjuicio de las finalidades que en cada caso se indiquen, dicha
					información será guardada y gestionada con su debida confidencialidad, 
					aplicando las medidas de seguridad informática establecidas en la
					legislación aplicable para impedir el acceso o uso indebido de sus
					datos, su manipulación, deterioro o pérdida.
					En cualquier momento puede Ud. ejercer sus derechos de acceso,
					rectificación o cancelación en relación con dichos datos, dirigiendo su
					solicitud a la dirección del titular de los ficheros. Puede encontrar
					formularios para el ejercicio de sus derechos en el sitio web de la Agencia
			...
			<section class="module content">
                <div class="container">	
					...
					<p><strong>USUARIOS:</strong> El acceso y/o uso de este portal atribuye la condición de
					...
					Contratación que en su caso resulten de obligado cumplimiento.</p>

					<p> <strong>USO DEL PORTAL:</strong> www.fastcv.net  proporciona el acceso a multitud de informaciones, 
					 servicios, programas o datos (en adelante, "los contenidos") en Internet pertenecientes al autor 
					 o a sus licenciantes a los que el USUARIO pueda tener acceso. El USUARIO asume la responsabilidad 
					 del uso del portal. Dicha responsabilidad se extiende al registro que fuese necesario para acceder 
					 a determinados servicios o contenidos. En dicho registro el USUARIO será responsable de aportar información 
					 veraz y lícita. Como consecuencia de este registro, al USUARIO se le puede proporcionar una contraseña 
					 ...
					 todos aquellos comentarios y aportaciones que vulneren el respeto a la dignidad de la persona, que sean 
					 discriminatorios, xenófobos, racistas, pornográficos, que atenten contra la juventud o la infancia, el orden 
					 o la seguridad pública o que, a su juicio, no resultaran adecuados para su publicación. En cualquier caso, 
					...
					o programas maliciosos o lesivos en los contenidos, a pesar de haber
					adoptado todas las medidas tecnológicas necesarias para evitarlo.</p>

					<p><strong>MODIFICACIONES:</strong> El autor del sitio
					web se reserva el derecho de efectuar sin previo aviso las
					...
					<p><strong>ENLACES:</strong> En el caso de que en nombre del dominio se
					dispusiesen enlaces o hipervínculos hacía otros sitios de Internet,
					el autor del sitio web no ejercerá ningún
					tipo de control sobre dichos sitios y contenidos. En ningún caso
					Nombre de la el autro del sitio web asumirá
					...
					<p><strong>DERECHO DE EXCLUSIÓN:</strong> el autor del
					sitio web se reserva el derecho a denegar o retirar el acceso a portal
					...
					<p><strong>GENERALIDADES:</strong> el autor del sitio
					web perseguirá el incumplimiento de las presentes condiciones así
					como cualquier utilización indebida de su portal ejerciendo todas las
					acciones civiles y penales que le puedan corresponder en derecho.</p>

					<p><strong>MODIFICACIÓN DE LAS PRESENTES CONDICIONES Y
					DURACIÓN:</strong> el autor del sitio web
					...
					<p><strong>LEGISLACIÓN APLICABLE Y JURISDICCIÓN:</strong> 
					La relación entre el autor del sitio web y el
					USUARIO se regirán por la normativa española vigente y
			...
			<section class="module content">
                <div class="container">	
					...
					<p>
					El autor  del  sitio  web, es titular de todos los derechos de propiedad intelectual e industrial de
					su página web, así como de los elementos contenidos en la misma (a 
					título enunciativo, imágenes, sonido, audio, vídeo, software o textos; 
					...
					para su funcionamiento, acceso y uso, etc.), titularidad del autor del sitio o bien de sus licenciantes. 
